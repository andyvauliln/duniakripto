...
const specprojects = [
	{
		...
		comments: 14,
		tags: 'NFT, Sport',
		src: 'https://forklog.com/wp-content/uploads/TimeCoinProtocol_Uni-min.png'
	},
	{
		id: 2,
		...
		tags: 'Bitcoin, Price',
		comments: 24,
		src: 'https://forklog.com/wp-content/uploads/Salvador_Bitcoin-min.png'
	},
	{
		id: 3,
		...
		comments: 22,
		src: 'https://forklog.com/wp-content/uploads/MDEX-min.png'
	},
	{
		id: 4,
		...
		comments: 65,
		src: 'https://forklog.com/wp-content/uploads/eth_forest-min.png'
	},
	{
		id: 5,
		...
		creator: 'Adamm Switch',
		comments: 12,
		src: 'https://forklog.com/wp-content/uploads/kucoin-min.png'
	}
];
export default function Section2() {
	const [state, setState] = useState('latest');
	let collection = state === 'latest' ? specprojects : specprojects.reverse();
	return (
		<Fragment>
			<HeaderWrapper>
				<LinkView tp="nav" fweight="900" fsize="lgt" href="/#specprojects">
					Spec Projects
				</LinkView>
				<LanguageWrapper
					ml="2em"
